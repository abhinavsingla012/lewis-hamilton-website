...
const HOTSPOTS = [
  { id: "head", top: "3.2%", left: "54%", side: "right", line: [[0, 0], [46, -34], [148, -34]], tag: "01 / THE MENTALITY", title: "STILL I RISE", copy: "It isn't a slogan — it's an operating system. Attack first, turn pressure into pole laps and chaos into masterclasses." },
  { id: "shoulders", top: "17%", left: "71%", side: "right", line: [[0, 0], [52, -12], [150, -12]], tag: "02 / THE RECORDS", title: "SEVEN CROWNS", copy: "Shoulders that carry history — 7 world championships and more career points than any driver who has ever raced." },
  { id: "heart", top: "25%", left: "56%", side: "left", line: [[0, 0], [-120, -14], [-225, -14]], tag: "03 / THE LOVES", title: "HIS PEOPLE", copy: "Dad Anthony worked four jobs to fund the karting. Mum Carmen kept him grounded. And Roscoe — the paddock's most famous bulldog." },
  { id: "hand", top: "42%", left: "80%", side: "right", line: [[0, 0], [46, 22], [140, 22]], tag: "04 / THE SILVERWARE", title: "105 TROPHIES", copy: "Hands that have lifted more winner's trophies than anyone in Formula 1 history — across 200+ podium visits." },
  { id: "helmet", top: "62%", left: "22%", side: "left", line: [[0, 0], [-42, 16], [-128, 16]], tag: "05 / THE ARMOURY", title: "MANY LIDS", copy: "A collector of identities — childhood yellow, championship purple, Senna tributes. Every helmet tells a chapter of the journey." },
  { id: "shoes", top: "89%", left: "62%", side: "right", line: [[0, 0], [50, -18], [145, -18]], tag: "06 / THE FOOTWORK", title: "104 POLES", copy: "Footwork tuned to dance on 5G brake zones — 104 pole positions, the greatest single-lap qualifier the sport has seen." },
];
    ...
    <div className="hw-figure-zone">
      <motion.div className="hw-figure" style={{ rotateX, rotateY }} initial={{ opacity: 0, y: 90, scale: 0.94 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 1.15, delay: 0.25, ease: [0.22, 1, 0.36, 1] }} data-testid="hero-lewis-cutout">
        ...
        {HOTSPOTS.map((spot, index) => {
          ...
          >
            <button type="button" className="hw-spot-dot" onClick={() => setActiveSpot((current) => (current === spot.id ? null : spot.id))} aria-label={`${spot.title} — details`} aria-expanded={activeSpot === spot.id} data-testid={`hero-hotspot-${spot.id}`}><i /></button>
